 ...
 * */
export const useTable = (api?: (params: any) => Promise<any>, initParam: object = {}, isPageable: boolean = true, dataCallBack?: (data: any) => any, requestError?: (error: any) => void) => {
  ...
  const getTableList = async () => {
    ...
    try {
      ...
      if (res.state === 200) {
        let { data } = res;
        dataCallBack && (data = dataCallBack(data.records));
